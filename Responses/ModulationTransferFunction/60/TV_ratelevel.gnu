...
d=1
f(x)=a*atan((x-c)/b)+d
fit f(x) 'TV_ratelevel_5810.dat' using 1:2 via a,b,c,d
set label 1 "MR = %.2f sp/s", (a*(pi/2))+d at 10,0.6
set label 2 "1/2 max = %.2f dBSPL", c at 10,0.5
set label 3 "THR = %.1f dBSPL", -((pi/2)*0.95*b)+c at 10,0.4
set label 4 "DR = %.1f ", pi*0.95*b at 10,0.3
set label 5 "spon = %.2f (sp/s)", d-f(c) at 10,0.2
plot  f(x), 'TV_ratelevel_5810.dat'  using 1:2  notitle with linespoints
#    EOF
