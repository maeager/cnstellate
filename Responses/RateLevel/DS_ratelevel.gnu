...
set terminal postscript eps enhanced defaultplex \
   ...
   "Helvetica" 14 
set output '/media/data/Work/cnstellate/Responses/RateLevel/DS_ratelevel.eps'
unset clip points
set clip one
unset clip two
...
plot  '/media/data/Work/cnstellate/Responses/RateLevel/DS_ratelevel_5810.dat'  using 1:2  notitle with linespoints
#    EOF
