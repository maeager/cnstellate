...
set terminal postscript eps enhanced defaultplex \
   ...
   "Helvetica" 18 
set output 'CELL_ratelevel_combined.eps'
unset clip points
set clip one
unset clip two
...
set xrange [ -10 : 120 ] noreverse nowriteback  # (currently [0.00000:100.000] )
...
plot  'RateLevel/CELL_ratelevel_5810.dat'  using 1:($2*REPS)  title "Tone RL" with linespoints ls 1, \
 ...
 'MaskedRateLevel/CELL_ratelevel_5810.dat'  using 1:($2*REPS)  title "Tone RL + 30dB Noise" with linespoints ls 3
