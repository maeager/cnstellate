...
plot '< tail -4 TStellate.Fit.dat | head -1 | awk ''{print $3}'' ' axes x1y1 t "Test" w lp lc "black" lt 1 lw 2 pt 7 ps 1.5,\
'< tail -4 TStellate.Fit.dat | head -1 | awk ''{print $2}'' ' axes x1y1 t "Ref" w lp ls 1 pt 5 ps 1.5, \
'< tail -3 TStellate.Fit.dat | head -2 | awk ''{print $3}'' ' u ($0+1):1 axes x2y2 notitle w p lc "black" lt 1 lw 2 pt 7 ps 1.5,\
'< tail -3 TStellate.Fit.dat | head -2 | awk ''{print $2}'' ' u ($0+1):1 axes x2y2 notitle w p ls 1 pt 5 ps 1.5
