...
set label 1 "MR = %.2f sp/s", (a*(pi/2))+d at 60,1.5
set label 2 "1/2 max = %.2f dBSPL", c at 60,1.25
set label 3 "THR = %.1f dBSPL", -((pi/2)*0.95*b)+c at 60,1.0
set label 4 "DR = %.1f ", pi*0.95*b at 60,0.75
set label 5 "spon = %.2f (sp/s)", d-f(c) at 60,0.5
plot  f(x), 'G_ratelevel_5810.dat'  using 1:2  notitle with linespoints
#    EOF
