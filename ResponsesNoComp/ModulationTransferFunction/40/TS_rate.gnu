...
set ylabel  offset character 0, 0, 0 font "Helvetica,24" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "Helvetica,24" textcolor lt -1 rotate by -270
set yrange [ 0 : * ] noreverse nowriteback  # (currently [2.00000:16.0000] )
...
set logscale x 10
set xrange [50:1000]
plot  'TS_rate_5810.dat'  using 1:2  notitle with linespoints ls 3
#    EOF
