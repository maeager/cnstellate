...
plot  [][:350] g(x) notitle , f(x) notitle, \
      'Spirou-Fig8A-RL-Control-BFTone.png.dat'  using 1:2  title "BF tone" with linespoints ls 3, \
      'Spirou-Fig8A-RL-withBic-BFTone.png.dat' u 1:2 title "Tone w Bic" w lp ls 3, \
      'Spirou-Fig8A-RL-withStrych-BFTone.png.dat' u 1:2 title "Tone w Str" w lp ls 3, \
      'Spirou-Fig8A-RL-Control-Noise.png.dat' u 1:2 title "BBN" w lp ls 3, \
      'Spirou-Fig8A-RL-withBic-Noise.png.dat' u 1:2 title "BBN w Bic" w lp ls 3, \
      'Spirou-Fig8A-RL-withStrych-Noise.png.dat' u 1:2 title "BBN w Str" w lp ls 3
